        ...
        <div className="flex max-[768px]:flex-col max-[768px]:text-center max-[768px]:gap-10 justify-between gap-10">
          ...
          <div className="footer-col w-[40%] max-[768px]:w-full">
            ...
            <div className="flex gap-4 mt-6 max-[768px]:justify-center">
              <a href="https://wa.me/573000000000" target="_blank" rel="noopener noreferrer" className="text-[rgba(255,255,255,0.55)] hover:text-[#00B4D8] transition-colors duration-300">
              ...
              <a href="#" className="text-[rgba(255,255,255,0.55)] hover:text-[#00B4D8] transition-colors duration-300">
