...
const categories = [
  { name: 'Audio', image: '/images/category-audio.jpg', icon: Headphones, count: 86, colSpan: 'col-span-2 row-span-2', aspect: 'aspect-square' },
  { name: 'Gaming', image: '/images/category-gaming.jpg', icon: Gamepad2, count: 64, colSpan: 'col-span-1 row-span-1', aspect: 'aspect-square' },
  { name: 'Wearables', image: '/images/category-wearables.jpg', icon: Watch, count: 42, colSpan: 'col-span-1 row-span-1', aspect: 'aspect-square' },
  { name: 'Streaming', image: '/images/category-streaming.jpg', icon: Video, count: 38, colSpan: 'col-span-2 row-span-1', aspect: 'aspect-[2/1]' },
  { name: 'Iluminación', image: '/images/category-iluminacion.jpg', icon: Lightbulb, count: 55, colSpan: 'col-span-1 row-span-1', aspect: 'aspect-square' },
  { name: 'Conectividad', image: '/images/category-conectividad.jpg', icon: Cable, count: 71, colSpan: 'col-span-1 row-span-1', aspect: 'aspect-square' },
];
