...
const categoryLinks = ['Audio', 'Gaming', 'Streaming', 'Wearables', 'Electrónica'];
const legalLinks = ['Términos', 'Privacidad', 'Contacto'];
        ...
        <div className="flex max-[768px]:flex-col max-[768px]:text-center max-[768px]:gap-10 justify-between gap-10">
          ...
          <div className="footer-col w-[40%] max-[768px]:w-full">
            <div className="flex items-center gap-2 mb-4 max-[768px]:justify-center">
              <span className="text-white text-2xl font-semibold">SarahBits</span>
              <span className="logo-dot w-2 h-2 bg-[#00B4D8] rounded-full inline-block" />
            </div>
            ...
            <div className="flex gap-4 mt-6 max-[768px]:justify-center">
              <a
                ...
                className="text-[rgba(255,255,255,0.55)] hover:text-[#00B4D8] transition-colors duration-300"
              >
          ...
          {/* Categories Column */}
          <div className="footer-col w-[30%] max-[768px]:w-full">
            <h4 className="text-[#90E0EF] text-xs font-medium tracking-[1.12px] uppercase mb-4">
              CATEGORÍAS
            </h4>
            <ul className="space-y-3">
              {categoryLinks.map((link) => (
                <li key={link}>
                  <a
                    href="#tienda"
                    className="text-[rgba(255,255,255,0.55)] text-base hover:text-white transition-colors duration-200"
                  >
                    {link}
                  </a>
                </li>
      ...
      <div className="border-t border-[rgba(255,255,255,0.12)] px-10 max-[768px]:px-5 py-6">
        <div className="max-w-[1200px] mx-auto flex max-[768px]:flex-col max-[768px]:text-center max-[768px]:gap-2 items-center justify-between">
          <span className="text-[rgba(255,255,255,0.55)] text-[13px]">
            © 2025 SarahBits. Todos los derechos reservados.
          </span>
          <span className="text-[rgba(255,255,255,0.55)] text-[13px]">
            🇨🇴 Hecho en Colombia
          </span>
