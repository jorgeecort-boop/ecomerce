    ...
    >
      <div className="relative z-10 px-10 max-[768px]:px-5 max-w-[700px] mx-auto text-center">
        ...
        <div ref={ctaRef} className="flex flex-wrap items-center justify-center gap-4 mt-10">
          <button className="bg-white text-[#FF006E] px-10 py-4 rounded-full font-medium flex items-center gap-2 hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(255,0,110,0.3)] transition-all duration-300">
            Comprar Ahora <ArrowRight size={18} />
          </button>
          <button className="text-white px-10 py-4 rounded-full font-medium border border-white hover:bg-[rgba(255,255,255,0.15)] transition-all duration-300">
            Ver Ofertas
          </button>
        </div>
